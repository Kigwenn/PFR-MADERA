...
class ClientControllerTest extends WebTestCase
{
    ...
    public function testClientCRUD()
    {
        ...
        $this->assertSame("regiotest",$responseData["adre_region"]);
        ...
        $this->assertSame("region2",$responseData["adre_region"]);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/PFR-MADERA/clients');
        $response = $client->getResponse();
        $this->assertSame(200, $response->getStatusCode());//test route
        $responseData = json_decode($response->getContent(), true);
    }
