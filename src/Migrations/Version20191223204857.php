 ...
 */
final class Version20191223204857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE composant (id INT AUTO_INCREMENT NOT NULL, fami_id INT DEFAULT NULL, comp_nom VARCHAR(200) NOT NULL, comp_prix DOUBLE PRECISION NOT NULL, comp_type VARCHAR(100) NOT NULL, comp_unite_usage NUMERIC(6, 2) NOT NULL, INDEX IDX_EC8486C982E6D09 (fami_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gamme (id INT AUTO_INCREMENT NOT NULL, remp_id INT NOT NULL, fiex_id INT NOT NULL, fiin_id INT NOT NULL, couv_id INT NOT NULL, huis_id INT NOT NULL, gamm_nom VARCHAR(100) NOT NULL, INDEX IDX_C32E14682D3F8FD7 (remp_id), INDEX IDX_C32E14683CA8945F (fiex_id), INDEX IDX_C32E14688C2A711D (fiin_id), INDEX IDX_C32E146838F6B854 (couv_id), INDEX IDX_C32E1468A7247E2 (huis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE module (id INT AUTO_INCREMENT NOT NULL, devi_id INT DEFAULT NULL, cctp_id INT NOT NULL, composants_id INT DEFAULT NULL, remp_id INT NOT NULL, fiex_id INT NOT NULL, fiin_id INT NOT NULL, couv_id INT NOT NULL, modu_nom VARCHAR(100) NOT NULL, modu_prix_unitaire DOUBLE PRECISION NOT NULL, INDEX IDX_C242628131098A5 (devi_id), INDEX IDX_C242628573F0E43 (cctp_id), INDEX IDX_C242628D960F9EE (composants_id), INDEX IDX_C2426282D3F8FD7 (remp_id), INDEX IDX_C2426283CA8945F (fiex_id), INDEX IDX_C2426288C2A711D (fiin_id), INDEX IDX_C24262838F6B854 (couv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE remplissage (id INT AUTO_INCREMENT NOT NULL, remp_nom VARCHAR(200) NOT NULL, remp_description VARCHAR(500) NOT NULL, remp_prix_unitaire NUMERIC(6, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
