 ...
 */
final class Version20200328195038 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caracteristique (id INT AUTO_INCREMENT NOT NULL, modu_id INT DEFAULT NULL, cara_section DOUBLE PRECISION NOT NULL, cara_hauteur DOUBLE PRECISION NOT NULL, cara_longueur DOUBLE PRECISION NOT NULL, cara_type_angle VARCHAR(15) NOT NULL, cara_degre_angle DOUBLE PRECISION NOT NULL, INDEX IDX_D14FBE8B27FCD2D5 (modu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cctp (id INT AUTO_INCREMENT NOT NULL, cctp_nom VARCHAR(255) NOT NULL, cctp_image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commercial (id INT AUTO_INCREMENT NOT NULL, pers_sexe VARCHAR(5) NOT NULL, pers_nom VARCHAR(50) NOT NULL, pers_prenom VARCHAR(50) NOT NULL, pers_mail VARCHAR(200) NOT NULL, pers_tel VARCHAR(10) NOT NULL, comm_mdp VARCHAR(50) NOT NULL, comm_token VARCHAR(64) DEFAULT NULL, comm_token_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, mais_id INT NOT NULL, etap_id INT NOT NULL, etat_id INT NOT NULL, adre_id INT NOT NULL, gamm_id INT DEFAULT NULL, comm_id INT NOT NULL, clie_id INT NOT NULL, devi_nom VARCHAR(100) NOT NULL, devi_date DATETIME NOT NULL, devi_prix DOUBLE PRECISION DEFAULT NULL, devi_dossier_estimatif LONGBLOB DEFAULT NULL, devi_dossier_technique LONGBLOB DEFAULT NULL, INDEX IDX_8B27C52BC00D28C8 (mais_id), INDEX IDX_8B27C52B823C11A8 (etap_id), INDEX IDX_8B27C52BD5E86FF (etat_id), UNIQUE INDEX UNIQ_8B27C52B35227DDF (adre_id), INDEX IDX_8B27C52B213BF1EA (gamm_id), INDEX IDX_8B27C52BEF7EB489 (comm_id), INDEX IDX_8B27C52B59DE4808 (clie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE maison (id INT AUTO_INCREMENT NOT NULL, mais_nom VARCHAR(100) NOT NULL, mais_prix DOUBLE PRECISION NOT NULL, mais_piece INT NOT NULL, mais_chambre INT NOT NULL, mais_description LONGTEXT NOT NULL, mais_catalogue LONGBLOB DEFAULT NULL, mais_cdp VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE module (id INT AUTO_INCREMENT NOT NULL, devi_id INT DEFAULT NULL, modu_reference_id INT DEFAULT NULL, cctp_id INT DEFAULT NULL, fiex_id INT DEFAULT NULL, fiin_id INT DEFAULT NULL, couv_id INT DEFAULT NULL, isol_id INT DEFAULT NULL, tymo_id INT NOT NULL, modu_nom VARCHAR(100) NOT NULL, modu_prix_unitaire DOUBLE PRECISION DEFAULT NULL, modu_prix_total DOUBLE PRECISION DEFAULT NULL, INDEX IDX_C242628131098A5 (devi_id), INDEX IDX_C242628FAFBE836 (modu_reference_id), INDEX IDX_C242628573F0E43 (cctp_id), INDEX IDX_C2426283CA8945F (fiex_id), INDEX IDX_C2426288C2A711D (fiin_id), INDEX IDX_C24262838F6B854 (couv_id), INDEX IDX_C242628FD661D22 (isol_id), INDEX IDX_C24262832813FC4 (tymo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT FK_8B27C52BEF7EB489 FOREIGN KEY (comm_id) REFERENCES commercial (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT FK_8B27C52B59DE4808 FOREIGN KEY (clie_id) REFERENCES client (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE module ADD CONSTRAINT FK_C24262832813FC4 FOREIGN KEY (tymo_id) REFERENCES type_module (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE caracteristique DROP FOREIGN KEY FK_D14FBE8B27FCD2D5');
        ...
        $this->addSql('ALTER TABLE module DROP FOREIGN KEY FK_C24262832813FC4');
