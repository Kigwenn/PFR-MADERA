 ...
 */
final class Version20191224011548 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE module (id INT AUTO_INCREMENT NOT NULL, devi_id INT DEFAULT NULL, cctp_id INT NOT NULL, fiex_id INT NOT NULL, fiin_id INT NOT NULL, couv_id INT NOT NULL, modu_nom VARCHAR(100) NOT NULL, modu_prix_unitaire DOUBLE PRECISION NOT NULL, INDEX IDX_C242628131098A5 (devi_id), INDEX IDX_C242628573F0E43 (cctp_id), INDEX IDX_C2426283CA8945F (fiex_id), INDEX IDX_C2426288C2A711D (fiin_id), INDEX IDX_C24262838F6B854 (couv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
